...
Taxes on conventional meat may also yield positive spillovers by accelerating the growth of plant-based alternatives. \citet{Zytkowicz2021} estimates that a \$3.53/lb tax on beef in the U.S. could reduce beef consumption by 15% and simultaneously increase plant-based meat demand by over 3 percent. This additional demand could trigger economies of scale, helping to close the price gap between meat and its sustainable substitutes.

\subsection{Case Study: Sweden’s Beef Tax Proposal}
Using a partial equilibrium model, \citet{Martensson2014} shows that a Pigouvian tax on beef in Sweden, differentiated by production method, could reduce consumption by nearly 8% and GHG emissions by over 780,000 tons CO$_2$e. The analysis affirms that targeted consumption taxes are both cost-effective and politically viable, especially when aligned with life-cycle assessments.
